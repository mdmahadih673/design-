  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 flex flex-col justify-end p-5 md:p-6">
        <span className="text-accent text-[9px] md:text-[10px] font-bold uppercase tracking-[0.2em] mb-1.5 transform -translate-y-1 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-300">
        ...
        <div className="flex items-center gap-3 overflow-hidden">
          <Link
            ...
            className="flex items-center gap-2 text-white/70 hover:text-white text-xs font-semibold transition-all group/link"
          >
